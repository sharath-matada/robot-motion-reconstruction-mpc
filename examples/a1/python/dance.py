...
t = np.array([0.1,0.7,1.1,1.3,1.7,1.9,2.3,2.5,2.9])
...
#1
contact_status_123 = robot.create_contact_status()
contact_status_123.activate_contacts(['RL_foot','FL_foot', 'RR_foot'])
contact_status_123.set_contact_placements(contact_positions)
contact_status_123.set_friction_coefficients(friction_coefficients)
contact_sequence.push_back(contact_status_123, t[0])

#2
contact_status_12 = robot.create_contact_status()
contact_status_12.activate_contacts(['RL_foot','FR_foot'])
contact_status_12.set_contact_placements(contact_positions)
contact_status_12.set_friction_coefficients(friction_coefficients)
contact_sequence.push_back(contact_status_12,t[1])

#3
contact_status_012 = robot.create_contact_status()
contact_status_012.activate_contacts(['FL_foot', 'RL_foot','FR_foot'])
contact_status_012.set_contact_placements(contact_positions)
contact_status_012.set_friction_coefficients(friction_coefficients)
contact_sequence.push_back(contact_status_012,t[2])


#4
contact_status_01 = robot.create_contact_status()
contact_status_01.activate_contacts(['FL_foot', 'RL_foot'])
contact_status_01.set_contact_placements(contact_positions)
contact_status_01.set_friction_coefficients(friction_coefficients)
contact_sequence.push_back(contact_status_01,t[3])

#5
contact_status_013 = robot.create_contact_status()
contact_status_013.activate_contacts(['FL_foot', 'RL_foot','RR_foot'])
contact_status_013.set_contact_placements(contact_positions)
contact_status_013.set_friction_coefficients(friction_coefficients)
contact_sequence.push_back(contact_status_013,t[4])

#6
contact_status_03 = robot.create_contact_status()
contact_status_03.activate_contacts(['FL_foot', 'RR_foot'])
contact_status_03.set_friction_coefficients(friction_coefficients)
contact_status_03.set_contact_placements(contact_positions)
contact_sequence.push_back(contact_status_03,t[5])


#7
contact_status_023 = robot.create_contact_status()
contact_status_023.activate_contacts(['FL_foot','FR_foot', 'RR_foot'])
contact_status_023.set_friction_coefficients(friction_coefficients)
contact_status_023.set_contact_placements(contact_positions)
contact_sequence.push_back(contact_status_023,t[6])


#8
contact_status_23 = robot.create_contact_status()
contact_status_23.activate_contacts(['FR_foot', 'RR_foot'])
contact_status_23.set_friction_coefficients(friction_coefficients)
contact_status_23.set_contact_placements(contact_positions)
contact_sequence.push_back(contact_status_23,t[7])
...
contact_status_123.set_friction_coefficients(friction_coefficients)
contact_status_123.set_contact_placements(contact_positions)
contact_sequence.push_back(contact_status_123,t[8])
